        ...
        datos.grupos.forEach(g => {
            ...
            $("td", $grupo).click(function() {
                if ((g.cont_ganadores <= 2) && ($(this).attr('id') != 'seleccionado')){
                    ...
                    $('[data-grupo='+g.letra+g.cont_ganadores+']').attr("style", "background-image: url(\"" + bandera + "\"); border: hidden; background-repeat: repeat-x; background-position: calc(100% - 10px) center; background-size: 100%;");
